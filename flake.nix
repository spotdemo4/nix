{
  ...
  inputs = {
    ...
    home-manager = {
      ...
      owner = "nix-community";
      repo = "home-manager";
      rev = "d2a22a3659a6ae99847ea9176114f6957b8ac62e";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    ...
    nur = {
      ...
      owner = "nix-community";
      repo = "NUR";
      rev = "1e1550db7eec819ecba8f872a8a34ef4cfa8b21f";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    ...
    niks3 = {
      ...
      owner = "Mic92";
      repo = "niks3";
      rev = "cc2e317288287cc9707a4108eb86fd3881b2f43c";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    ...
    nix4vscode = {
      ...
      owner = "nix-community";
      repo = "nix4vscode";
      rev = "79eb3e7e13d248f98eb10e8fa506529ad1312f35";
      inputs = {
    ...
    trevpkgs = {
      ...
      owner = "spotdemo4";
      repo = "trevpkgs";
      rev = "74ee7a5cab71b2da93cb25a78c626e2f747fccf6";
      inputs = {
        systems.follows = "systems";
        nixpkgs.follows = "nixpkgs";
      };
    ...
    zen-browser = {
      ...
      rev = "812a7ed1e6aa4ad468b4f9fd0d2bf908d52cf102";
      inputs = {
        nixpkgs.follows = "nixpkgs";
