{
  ...
  inputs = {
    ...
    nur = {
      ...
      owner = "nix-community";
      repo = "NUR";
      rev = "1208d8b9154b59c66c69b864c1e7a566b3de5374";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    ...
    nix4vscode = {
      ...
      owner = "nix-community";
      repo = "nix4vscode";
      rev = "0378e001f658e1fa2a8fda4c9a2b676ec19ab3b4";
      inputs = {
    ...
    trevpkgs = {
      ...
      owner = "spotdemo4";
      repo = "trevpkgs";
      rev = "242d84dc2a773109bf58204ce665f87def3e9de5";
      inputs = {
        systems.follows = "systems";
        nixpkgs.follows = "nixpkgs";
      };
    ...
    zen-browser = {
      ...
      rev = "cf55fc2a2d26819d0dfb4f5e21fad13d70a612e9";
      inputs = {
        nixpkgs.follows = "nixpkgs";
