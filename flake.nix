{
  ...
  inputs = {
    ...
    nur = {
      ...
      owner = "nix-community";
      repo = "NUR";
      rev = "8adff0526042a4ee1d315e11f8ef9847cb0c0dac";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    ...
    nix4vscode = {
      ...
      owner = "nix-community";
      repo = "nix4vscode";
      rev = "70203f12f3004b40e74fcbe75cd49676b2916f08";
      inputs = {
    ...
    trevpkgs = {
      ...
      owner = "spotdemo4";
      repo = "trevpkgs";
      rev = "0400231172dbc835fe4fe40abc271adb855294ff";
      inputs = {
        systems.follows = "systems";
        nixpkgs.follows = "nixpkgs";
      };
    ...
    zen-browser = {
      ...
      rev = "f7351ed60d70cc2e5d17f3f8a4530e822befdd5a";
      inputs = {
        nixpkgs.follows = "nixpkgs";
