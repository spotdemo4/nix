{
  ...
  inputs = {
    ...
    nur = {
      ...
      owner = "nix-community";
      repo = "NUR";
      rev = "59d805f40c5d3eda7ef86b5c20b86bc73a30c124";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    ...
    niks3 = {
      ...
      owner = "Mic92";
      repo = "niks3";
      rev = "12aca615d781979d1f8526a197bb0c5dc5d8c3a8";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    ...
    nix4vscode = {
      ...
      owner = "nix-community";
      repo = "nix4vscode";
      rev = "17a7e9932c540d38732581f206c4db48ffc75929";
      inputs = {
    ...
    trevpkgs = {
      ...
      owner = "spotdemo4";
      repo = "trevpkgs";
      rev = "0c7f99aaff8de62403b0c940a9b31d9cafbc7b7c";
      inputs = {
        systems.follows = "systems";
        nixpkgs.follows = "nixpkgs";
      };
    ...
    trevbar = {
      ...
      owner = "spotdemo4";
      repo = "trevbar";
      rev = "21237b2b4bfbdb1ae9b881367470e881e44c8658";
      inputs = {
        systems.follows = "systems";
        nixpkgs.follows = "nixpkgs";
