{
  ...
  inputs = {
    ...
    niks3 = {
      ...
      owner = "Mic92";
      repo = "niks3";
      rev = "04e92c0b0696134d63b2ea44ab9fa51c6361e85a";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    ...
    nix4vscode = {
      ...
      owner = "nix-community";
      repo = "nix4vscode";
      rev = "8d8ebba645001ca26b12e09015af28f365f981e1";
      inputs = {
    ...
    trevpkgs = {
      ...
      owner = "spotdemo4";
      repo = "trevpkgs";
      rev = "7bf622592ca6d4638ed33b93b561076c6139d3b2";
      inputs = {
        systems.follows = "systems";
        nixpkgs.follows = "nixpkgs";
      };
    ...
    zen-browser = {
      ...
      rev = "7e5eae4a0ec7d29b83858ba5f54e156a19bbffbf";
      inputs = {
        nixpkgs.follows = "nixpkgs";
