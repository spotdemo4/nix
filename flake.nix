{
  ...
  inputs = {
    ...
    nur = {
      ...
      owner = "nix-community";
      repo = "NUR";
      rev = "d939214415bd01b4fe542aae17bceba5833fae97";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    ...
    nix4vscode = {
      ...
      owner = "nix-community";
      repo = "nix4vscode";
      rev = "361b345bf158d1b0096ab520c8b03825a3ac2a0e";
      inputs = {
    ...
    trevpkgs = {
      ...
      owner = "spotdemo4";
      repo = "trevpkgs";
      rev = "1dd9bee804d8bbc0422182053db99853b2d7aa6f";
      inputs = {
        systems.follows = "systems";
        nixpkgs.follows = "nixpkgs";
      };
    ...
    zen-browser = {
      ...
      rev = "e1a0481218312579ad67eda819ad964176fbe28b";
      inputs = {
        nixpkgs.follows = "nixpkgs";
    ...
    trevbar = {
      ...
      owner = "spotdemo4";
      repo = "trevbar";
      rev = "40bde1ffe4a968ad8206bc23c68f67e3e4d5b3a7";
      inputs = {
        systems.follows = "systems";
        nixpkgs.follows = "nixpkgs";
