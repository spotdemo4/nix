{
  ...
  inputs = {
    ...
    determinate = {
      ...
      repo = "determinate";
      rev = "3ab752595b32fcbc26c7f41d56b981f6040b8f73";
    ...
    home-manager = {
      ...
      owner = "nix-community";
      repo = "home-manager";
      rev = "f2785222a14e90f8c5ad2ff62474ce88453c3421";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    ...
    nur = {
      ...
      owner = "nix-community";
      repo = "NUR";
      rev = "3101e078666754dad3943abe6b3afb933a9f4b24";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    ...
    niks3 = {
      ...
      owner = "Mic92";
      repo = "niks3";
      rev = "f8e74b691e7a1a631a2d954d29c5f726f4cf5def";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    ...
    nix4vscode = {
      ...
      owner = "nix-community";
      repo = "nix4vscode";
      rev = "50f52b2cce314bbc273f7c0864849038c91cf935";
      inputs = {
    ...
    trevpkgs = {
      ...
      owner = "spotdemo4";
      repo = "trevpkgs";
      rev = "f1e399aad4913e0be341e56ee8ff1079e0334790";
      inputs = {
        systems.follows = "systems";
        nixpkgs.follows = "nixpkgs";
      };
    ...
    zen-browser = {
      ...
      rev = "a12d482485d877cc066516ea256b435b209a1a8c";
      inputs = {
        nixpkgs.follows = "nixpkgs";
    ...
    trevbar = {
      ...
      owner = "spotdemo4";
      repo = "trevbar";
      rev = "56ab0e24c9626f9b7b47e59c7cffb6477f89f504";
      inputs = {
        systems.follows = "systems";
        nixpkgs.follows = "nixpkgs";
