{
  ...
  inputs = {
    ...
    home-manager = {
      ...
      owner = "nix-community";
      repo = "home-manager";
      rev = "a5768f1a46942657352e58037b7891bdcbc0741f";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    ...
    niks3 = {
      ...
      owner = "Mic92";
      repo = "niks3";
      rev = "1c74f969454c91db023fc37f286b5a113c30cdd6";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    ...
    trevpkgs = {
      ...
      owner = "spotdemo4";
      repo = "trevpkgs";
      rev = "5603c0f4982a524d077a4d4fb248b4794bdfdb51";
      inputs = {
        systems.follows = "systems";
        nixpkgs.follows = "nixpkgs";
      };
    ...
    zen-browser = {
      ...
      rev = "1c3a1fcacf97eb3792e9292e3afc0edbfcfa01d4";
      inputs = {
        nixpkgs.follows = "nixpkgs";
