{
  ...
  inputs = {
    ...
    determinate = {
      ...
      repo = "determinate";
      rev = "e174ad0adf5ff0768e5580954ae068fe3ac72b9b";
    ...
    nur = {
      ...
      owner = "nix-community";
      repo = "NUR";
      rev = "42898e5eee17b96d8c63a898479a09cf9eab690e";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    ...
    nix4vscode = {
      ...
      owner = "nix-community";
      repo = "nix4vscode";
      rev = "af7430b7672103e6d5f18267b21971dd03787535";
      inputs = {
    ...
    zen-browser = {
      ...
      rev = "09ea94b39f36fbee3361aaf47c2d8f3e4e123eaa";
      inputs = {
        nixpkgs.follows = "nixpkgs";
