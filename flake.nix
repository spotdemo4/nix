{
  ...
  inputs = {
    ...
    nur = {
      ...
      owner = "nix-community";
      repo = "NUR";
      rev = "bf1d96f4683bc3b95d33bcc7b4d3e139e24fd5cf";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    ...
    nix4vscode = {
      ...
      owner = "nix-community";
      repo = "nix4vscode";
      rev = "52bfbf1084d8739cffd1c283ef81c50ae72887a2";
      inputs = {
    ...
    trevpkgs = {
      ...
      owner = "spotdemo4";
      repo = "trevpkgs";
      rev = "f5b0a775955452362a1c3ce87a83a9440054f88b";
      inputs = {
        systems.follows = "systems";
        nixpkgs.follows = "nixpkgs";
      };
    ...
    zen-browser = {
      ...
      rev = "163fb9c2cb58f402ea8da849e0412d583b7fdf3b";
      inputs = {
        nixpkgs.follows = "nixpkgs";
