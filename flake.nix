{
  ...
  inputs = {
    ...
    nixpkgs = {
      ...
      ref = "nixos-unstable";
      rev = "efe6f071ede9d21c37462d2d6682d5e670099684";
      shallow = true;
    };
    ...
    nur = {
      ...
      owner = "nix-community";
      repo = "NUR";
      rev = "209b2d806503b93c6bb5d076605ba741503f62d5";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    ...
    catppuccin = {
      ...
      owner = "catppuccin";
      repo = "nix";
      rev = "3142fdbeea0b181ad6600587dfe484ccb644dcc6";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    ...
    niks3 = {
      ...
      owner = "Mic92";
      repo = "niks3";
      rev = "c4815870c9c94d0196f42bb58f53f639478321e1";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    ...
    nix4vscode = {
      ...
      owner = "nix-community";
      repo = "nix4vscode";
      rev = "57fb7ae9ef7cfbd009894c91cc954095541da904";
      inputs = {
    ...
    trevpkgs = {
      ...
      owner = "spotdemo4";
      repo = "trevpkgs";
      rev = "8480a51767c619aefe5697432cf262c6018b3fb8";
      inputs = {
        systems.follows = "systems";
        nixpkgs.follows = "nixpkgs";
      };
    ...
    zen-browser = {
      ...
      rev = "af28d05de9c7deff95006c9b812dc9d31a6332af";
      inputs = {
        nixpkgs.follows = "nixpkgs";
    ...
    trevbar = {
      ...
      owner = "spotdemo4";
      repo = "trevbar";
      rev = "f1f8efd375c91f79d34e507436b632c5c5429707";
      inputs = {
        systems.follows = "systems";
        nixpkgs.follows = "nixpkgs";
