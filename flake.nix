{
  ...
  inputs = {
    ...
    home-manager = {
      ...
      owner = "nix-community";
      repo = "home-manager";
      rev = "58405b3b0ce13e9cd4af7dc697687b4d9b74e56d";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    ...
    nur = {
      ...
      owner = "nix-community";
      repo = "NUR";
      rev = "19d471bced4d42c419a8882feaefe0a5c94643a4";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    ...
    nix4vscode = {
      ...
      owner = "nix-community";
      repo = "nix4vscode";
      rev = "418398ade44973a05d9e669c65d1e591a225154b";
      inputs = {
    ...
    zen-browser = {
      ...
      rev = "399b63846cc02625e8f4614c195d72294ff3e510";
      inputs = {
        nixpkgs.follows = "nixpkgs";
    ...
    trevbar = {
      ...
      owner = "spotdemo4";
      repo = "trevbar";
      rev = "ee5c6ab47fcbc9f3f1915b67d0eae99df66656a0";
      inputs = {
        systems.follows = "systems";
        nixpkgs.follows = "nixpkgs";
