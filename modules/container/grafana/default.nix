...
in
{
  options.trev.containers.grafana = {
    ...
    image = containerOptions.mkImageOption "docker.io/grafana/grafana-enterprise:13.1.0@sha256:68a7ee3dc2c726e54b2be3533a9e1ac6baaed0893334947a6378520de28a6a76";
