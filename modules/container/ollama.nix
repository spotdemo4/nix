  ...
  virtualisation.quadlet = {
    containers = {
      ollama.containerConfig = {
        image = "docker.io/intelanalytics/ipex-llm-inference-cpp-xpu:latest@sha256:ce55300ac5eaeea3639a473314d54adbd80bcb8113c99addbe1673272e3b34f4";
        pull = "missing";
        environments = {
          DEVICE = "Arc";
        };
      ...
      open-webui.containerConfig = {
        image = "ghcr.io/open-webui/open-webui:main@sha256:b101231569b46b326f8badfde103aa570fb97d962140a5ef08ee2603d6458be7";
        pull = "missing";
        environments = {
