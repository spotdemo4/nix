  ...
  virtualisation.quadlet = {
    containers = {
      ollama.containerConfig = {
        image = "docker.io/intelanalytics/ipex-llm-inference-cpp-xpu:latest@sha256:0b1caab07fd18e294d263fb9aa49967413bf3e6e03033b79281fc9332c134ab4";
        pull = "missing";
        environments = {
          DEVICE = "Arc";
        };
      ...
      open-webui.containerConfig = {
        image = "ghcr.io/open-webui/open-webui:main@sha256:74a5ee5c453e628c2bcd33a41dfe4dcf62d187fedf4867d6b8a087178cd88aa6";
        pull = "missing";
        environments = {
