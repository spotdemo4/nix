...
in {
  ...
  virtualisation.quadlet = {
    containers = {
      traefik = {
        containerConfig = {
          image = "docker.io/traefik:v3.5.3@sha256:76ac93e6ff8c749c9b68e31698e93d3af38c6a6d10a6b989eeef97bf0b9887f8";
          pull = "missing";
          secrets = [
      ...
      traefik-certs-dumper.containerConfig = {
        image = "ghcr.io/kereis/traefik-certs-dumper:1.8.11@sha256:2a5468c9fdeb53b4db26adb2102d8ed2997cbeef3d7925694b9dd9d32c748806";
        pull = "missing";
        user = "1000";
        group = "1000";
        addCapabilities = [
