...
in
{
  ...
  virtualisation.quadlet = {
    containers.monerod.containerConfig = {
      image = "ghcr.io/sethforprivacy/simple-monerod:v0.18.4.6@sha256:3c96f72d9b903623f13cc2a8460ec58ff440b2b58cfc797e11a02983e0cf155e";
      pull = "missing";
      volumes = [
    ...
    networks = {
      monero.networkConfig.interfaceName = "eth0";
    };
  };
}
